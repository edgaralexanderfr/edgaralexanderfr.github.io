...
Command: npx @threlte/gltf@3.0.1 public/models/model/testscene1.glb --types
-->
...
<script lang="ts">
	...
	const gltf = useGltf<GLTFResult>('/models/model/testscene1.glb');
...
<T is={ref} dispose={false} {...props}>
	...
	{:then gltf}
		<T.Group name="Scene">
			<T.Group name="EdgarArmature" position={[3.15, -0.29, -4.4]}>
				<T is={gltf.nodes.Hip} />
